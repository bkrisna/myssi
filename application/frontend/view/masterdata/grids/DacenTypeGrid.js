Ext.define('MYSSI.view.masterdata.grids.DacenTypeGrid' ,{
    extend: 'Ext.grid.Panel',
    alias : 'widget.DacenTypeGrid',
	id: 'dacenTypeGrid',
	buttonTextMode: 'show',

	deleteButtonText: "Delete Datacenter Type",
    deleteButtonIcon: '',
    deleteButtonIconCls: 'web-icon delete',

    addButtonText: "Add Datacenter Type",
    addButtonIcon: '',
