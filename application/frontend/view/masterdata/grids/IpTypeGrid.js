Ext.define('MYSSI.view.masterdata.grids.IpTypeGrid' ,{
    extend: 'Ext.grid.Panel',
    alias : 'widget.IpTypeGrid',
	id: 'ipTypeGrid',
	buttonTextMode: 'show',

	deleteButtonText: "Delete IP Address Type",
    deleteButtonIcon: '',
    deleteButtonIconCls: 'web-icon delete',

    addButtonText: "Add IP Address Type",
    addButtonIcon: '',
