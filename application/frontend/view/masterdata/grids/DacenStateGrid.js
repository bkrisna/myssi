Ext.define('MYSSI.view.masterdata.grids.DacenStateGrid' ,{
    extend: 'Ext.grid.Panel',
    alias : 'widget.DacenStateGrid',
	id: 'dacenStateGrid',
	buttonTextMode: 'show',

	deleteButtonText: "Delete Datacenter State",
    deleteButtonIcon: '',
    deleteButtonIconCls: 'web-icon delete',

    addButtonText: "Add Datacenter State",
    addButtonIcon: '',
