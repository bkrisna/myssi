Ext.define('MYSSI.view.masterdata.grids.EngineeredTypeGrid' ,{
    extend: 'Ext.grid.Panel',
    alias : 'widget.EngineeredTypeGrid',
	id: 'engineeredTypeGrid',
	buttonTextMode: 'show',

	deleteButtonText: "Delete Engineered System Type",
    deleteButtonIcon: '',
    deleteButtonIconCls: 'web-icon delete',

    addButtonText: "Add Engineered System Type",
    addButtonIcon: '',
	...
	initComponent: function() {
		...
		Ext.apply(this, {
			...
			columns: [{
				...
				header: 'Engineered System Type Name',
				flex:1,
				dataIndex: 'type_name'
			}]
        });
