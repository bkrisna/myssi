Ext.define('MYSSI.view.masterdata.grids.CredentialTypeGrid' ,{
    extend: 'Ext.grid.Panel',
    alias : 'widget.CredentialTypeGrid',
	id: 'credentialTypeGrid',
	buttonTextMode: 'show',

	deleteButtonText: "Delete Credential Type",
    deleteButtonIcon: '',
    deleteButtonIconCls: 'web-icon delete',

    addButtonText: "Add Credential Type",
    addButtonIcon: '',
