Ext.define('MYSSI.view.masterdata.grids.ProjectStateGrid' ,{
    extend: 'Ext.grid.Panel',
    alias : 'widget.ProjectStateGrid',
	id: 'projectStateGrid',
	buttonTextMode: 'show',

	deleteButtonText: "Delete Project State",
    deleteButtonIcon: '',
    deleteButtonIconCls: 'web-icon delete',

    addButtonText: "Add Project State",
    addButtonIcon: '',
