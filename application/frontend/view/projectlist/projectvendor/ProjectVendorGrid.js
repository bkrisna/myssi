Ext.define('MYSSI.view.projectlist.projectvendor.ProjectVendorGrid' ,{
    extend: 'Ext.grid.Panel',
    alias : 'widget.ProjectVendorGrid',
	id: 'projectVendorGrid',
	buttonTextMode: 'hide',

	deleteButtonText: "De-Assign Vendor",
    deleteButtonIcon: '',
    deleteButtonIconCls: 'web-icon user_delete',

    addButtonText: "Assign Vendor",
    addButtonIcon: '',
