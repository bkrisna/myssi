 ...
 *
 */
Ext.define('MYSSI.view.serverinv.SIAssetGrid', {
    extend: 'MYSSI.view.widgets.editor.EditorGrid',
    ...
    initComponent: function ()
    {
        ...
        this.groupingFeature = Ext.create('Ext.grid.feature.Grouping', {
            ...
            groupHeaderTpl: '{name} ({rows.length} ' + "Asset(s)" + ")"
        });
