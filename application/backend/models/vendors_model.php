...
class Vendors_model extends CI_Model {
    ...
    function __construct() {
		...
		$this->table = 'myssi_vendors';

		$this->table_fields = array(
			$this->table.'.id',
            $this->table.'.vendor_name',
            $this->table.'.vendor_alias',
            $this->table.'.vendor_url',
            $this->table.'.vendor_addr',
            $this->table.'.vendor_pic_name',
            $this->table.'.vendor_pic_tel',
            $this->table.'.vendor_pic_email'
		);
