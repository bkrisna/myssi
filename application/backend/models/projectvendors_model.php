...
class Projectvendors_model extends CI_Model {
    ...
    function __construct() {
        ...
        $this->table_fields_join = array(
            $this->table_join[0]['table_name'].'.vendor_name',
            $this->table_join[0]['table_name'].'.vendor_alias',
            $this->table_join[1]['table_name'].'.type_name'
        );
    }
